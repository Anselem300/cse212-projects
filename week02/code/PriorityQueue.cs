...
/// <summary>
/// Implements a queue where each item has a priority.
/// Higher numbers = higher priority. FIFO is used for items with same priority.
/// </summary>
public class PriorityQueue
{
    ...
    /// If multiple items share the same highest priority, the first one added is removed (FIFO).
